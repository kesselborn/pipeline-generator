...
func templates_jenkins_normal_job_xml() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/jenkins/normal-job.xml", size: 8008, mode: os.FileMode(420), modTime: time.Unix(1434460920, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
